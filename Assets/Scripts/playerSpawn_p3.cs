...
public class playerSpawn_p3 : MonoBehaviour
{
    ...
    void Update()
    {
        GamePadState currentState = GamePad.GetState(playerIndex);
            ...
            {
                if (GameManagerScript.player3AI)
                {
                ...
                if (currentState.Buttons.A == ButtonState.Pressed && GameManagerScript.p3Spawnable && !GameManagerScript.player3AI)
                {
